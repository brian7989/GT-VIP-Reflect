...
import TransposedTeamStakeholdersWeightingProposalsTable from '../Components/TransposedTeamStakeholdersWeightingProposalsTable.js';
...
const TransposedStakeholdersTableWithDataPropTypes = {
...
const TransposedTeamStakeholdersWeightingProposalsTableWithData = compose (
    ...
    graphql(CreateStakeholderProposalMutation, {
        ...
        props: ({ createStakeholderProposalMutation, ownProps: {userId, problemId} }) => ({
            addStakeholderProposal: (stakeholderId, proposalId, weight) => {
                ...
                console.log("Add stakeholder proposal");

                let iweight = parseInt(weight) || 0;
    ...
    graphql(UpdateStakeholderProposalMutation, {
        ...
        props: ({ updateStakeholderProposalMutation }) => ({
            updateStakeholderProposal: (stakeholderId, proposalId, weight) => {
                ...
                console.log("updateStakeholderProposal");
...
)(TransposedTeamStakeholdersWeightingProposalsTable);



TransposedTeamStakeholdersWeightingProposalsTableWithData.propTypes = TransposedStakeholdersTableWithDataPropTypes;


export default TransposedTeamStakeholdersWeightingProposalsTableWithData;
