...
import JustificationsView from '../Components/JustificationsView.js';
...
query allProposals($teamId:Int!, $problemId:Int!, $step:String!){
    ...
    allProposals(condition:{teamId: $teamId, problemId:$problemId, step:$step, isActive: true}, orderBy:DISPLAY_ORDER_ASC) {
...
const JustificationsViewWithData = compose (
...
JustificationsViewWithData.propTypes = JustificationsTableWithDataPropTypes;


//export default JustificationsTableWithData;
export  { JustificationsViewWithData, getProposals, OnlyProposalsQuery, getTeams}
