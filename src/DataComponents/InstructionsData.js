...
//const InstructionsData = i18n.t("My Account");



//console.log("***************INSTRUCTIONS***************** isInit?: " + i18n.isInitialized);
//console.log(InstructionsData);

export const GetLocalizedInstructions = (t) =>
{
    let ret = t('instructions:data', { returnObjects: true });
...
BatchUploads : {
Instructions : {
title: <div>Batch Upload Instructions</div>,
body: <div>
<ul>
<li>Usernames must not contain any empty spaces.</li>
