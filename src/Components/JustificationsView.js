...
class JustificationsView extends Component {
            ...
            <div>
...

                {
                    this.props.proposals.map( (p) => {
                            ...
                            return <p key={p.displayOrder}>{p.proposalText}</p>;
                        }
                    )
                }
...
JustificationsView.propTypes = JustificationsTablePropTypes;


export default JustificationsView;
