        ...
        return (
            ...
            <Modal show={true}>
...

                {
                        ...
                        < Modal.Header >
                            < Modal.Title > Register New User: {this.props.registrationUser}</Modal.Title>
                            <CreatePasswordForm
                                submit={(password, repeatPassword) => {
                                    ...
                                    else if(password.length < 6 )
                                    {
                                        ...
                                        fetch(url + "api/users/" + this.props.registrationUser + "/activate", {
                                            method: 'post',
                                            headers: {
...
AuthorizeNewUserFormIntermed.propTypes = AuthorizeNewUserPropTypes;
const AuthorizeNewUserForm = withRouter(AuthorizeNewUserFormIntermed);

export default AuthorizeNewUserForm;
