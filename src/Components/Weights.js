...
import {
    Checkbox, FormControl, FormGroup, Panel
...
class Weights extends Component {
    ...
    render() {
        ...
        return (
            ...
            <br></br>
            <h3>
            How much does each stakeholder like or dislike the final proposal?</h3>
            <p>
        If all weights are positive or neutral, proceed to the next step.
            If not, continue working on this problem (divide labor into individual homework or sub-teams as you see fit).
        If you think there is fundamental disagreement, distinguish two alternative proposals and formulate them so that one group of stakeholders could agree on one proposal, and another one on the other.
            </p>
            {this.props.instructions ?
            < InstructionsPanel
        title = {this.props.instructions.Weighting.title}
        body = {this.props.instructions.Weighting.body}
        />
    : <div></div>
    }
...
Weights.propTypes = JustificationsTablePropTypes;
