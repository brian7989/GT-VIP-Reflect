...
const ConsiderationsTablePropTypes = {
...
class CurrentTeamMemberEditor extends React.Component {
    ...
    render() {
        ...
        return (
            <form>
            <FormGroup
        controlId="formSelectTeamMemberConsiderations"
...
class ConsiderationsTable extends Component {
    ...
    render() {
        ...
        invalidEditColumnClassName='invalid-proposal-class'>Consideration Items</TableHeaderColumn>
...
ConsiderationsTable.propTypes = ConsiderationsTablePropTypes;


export default ConsiderationsTable;
